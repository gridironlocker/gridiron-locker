...
COLLECTIONS = {
    "cleveland-browns": dict(
        ...
        ink="#ffffff",
        hero="/img/hero-cleveland.jpg?v=2",
    ...
    "green-bay-packers": dict(
        ...
        ink="#ffffff",
        hero="/img/hero-greenbay.jpg?v=2",
    ...
    "michigan": dict(
        ...
        ink="#ffffff",
        hero="/img/hero-michigan.jpg?v=2",
